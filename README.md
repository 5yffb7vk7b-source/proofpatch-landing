...
Public landing page for [ProofPatch](https://proofpatch-landing.vercel.app) — a local evidence layer for AI coding-agent work.
...
**https://proofpatch-landing.vercel.app**
